 ...
 */
final class Version20230425015045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clubs_club_list (id INT AUTO_INCREMENT NOT NULL, num_tab INT NOT NULL, club_nom VARCHAR(20) NOT NULL, club_members_nb INT NOT NULL, club_institut VARCHAR(30) NOT NULL, club_activity_type VARCHAR(20) NOT NULL, club_rep_name VARCHAR(255) NOT NULL, club_rep_email VARCHAR(30) NOT NULL, club_img VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
